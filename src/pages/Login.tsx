...
export function Login() {
    ...
    const loginWithGoogle = async () => {
        window.location.href = "http://localhost:8194/oauth2/authorization/google";
    };

    const loginWithGithub = async () => {
        window.location.href = "http://localhost:8194/oauth2/authorization/github";
    };
            ...
            <div className="w-full max-w-md bg-gray-100 dark:bg-slate-900 rounded-2xl shadow-xl p-8 space-y-6">
                ...
                <div className="relative">
                    ...
                    <div className="relative flex justify-center text-sm">
                        <span className="px-2 bg-gray-50 dark:bg-slate-900 text-gray-500">Or continue with</span>
                    </div>
                </div>

                <div className="grid grid-cols-2 gap-4">
                    <button onClick={loginWithGoogle}
                            className="flex items-center justify-center gap-2 px-4 py-2 border border-gray-300 dark:border-slate-700 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors">
                        <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current">
                            ...
                            <path
                                ...
                                fill="#FBBC05"/>
                            <path
                                d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 7.7-4.53z"
                                fill="#EA4335"/>
                        </svg>
                        <span>Google</span>
                    </button>
